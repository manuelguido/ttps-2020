          ...
          <div class="card-body p-md-4 p-lg-5">
            ...
            <div v-if="!editing" class="row">
              ...
              <div class="col-12 mb-5 d-flex justify-content-between align-items-center">
                <span><dashboard-title text="Perfil de usuario"></dashboard-title></span>
                <span class="btn p-2 waves-effect" @click="editProfile(true)"><i class="fad fa-pencil black-alpha-30 mr-2"></i>Editar</span>
              </div>
            ...
            <div v-else class="row justify-content-center">
              ...
              <div class="col-12 mb-5 d-flex justify-content-between align-items-center">
                ...
                <span class="btn p-2 waves-effect" @click="editProfile(false)"><i class="fad fa-times black-alpha-30 mr-2"></i>Cancelar</span>
              </div>
              <!-- /.Title -->
...
export default {
  ...
  methods: {
     ...
     */
    dni() {
      return (this.user.dni/1).toFixed(0).replace('.').toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".")
    },
